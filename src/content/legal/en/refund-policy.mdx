...
- For bespoke products or services manufactured or produced according to your specific requirements.

### How to exercise your Right of Withdrawal

To exercise your right of withdrawal, you must inform us of your decision to withdraw from the contract through an unambiguous statement before the withdrawal period has expired. This can be done via email to refund@hallin.media.
...
### Effect of Exercised Right of Withdrawal

When you exercise your right of withdrawal, we will reimburse all payments received from you, without undue delay and no later than 14 days from the day we were informed of your decision to withdraw from the contract.

The refund will be made using the same payment method you used for the purchase, unless otherwise agreed.

## Refund Policy for Commenced Projects

### Consultancy Services and Time-based Assignments
...
- For digital subscription services, the terms in section "Monthly Services and Subscriptions" above apply.
